...
static const CGFloat kLabelHeight = 98.0f;
    ...
    if(notifierView) {
        ...
        [self updateNotifierWithAnimation:notifierView withText:text completion:^(BOOL finished) {
            ...
            if(!shouldDismiss) {
                ...
                [separatorImageView setBackgroundColor: [UIColor colorWithRed:95.f/255.f green:177.f/255.f blue:191.f/255.f alpha:1.f]];
        ...
        notifierView.backgroundColor =  [UIColor colorWithRed:95.f/255.f green:177.f/255.f blue:191.f/255.f alpha:1.f];
