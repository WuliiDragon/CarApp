...
//
//@implementation HBShoppingCartView
//
...
//    
//    
//    self.line = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, mainScreenWidth, 0.5)];
...
//    
//    //小圆点
//    self.badge = [[HBBadgeView alloc] initWithFrame:CGRectMake(self.shoppingCartBtn.frame.size.width - 18, 5, 18, 18) withString:nil];
...
//    self.OrderList = [[HBGoodsListView alloc] initWithFrame:CGRectMake(0,self.parentView.bounds.size.height - maxHeight, self.bounds.size.width, maxHeight) withObjects:nil  canReorder:YES];
//    
//    self.OverlayView = [[HBOverlayView alloc] initWithFrame:CGRectMake(0, 0, mainScreenWidth, mainScreenHeight-50)];
