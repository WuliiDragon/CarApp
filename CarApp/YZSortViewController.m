...
- (void)viewDidLoad {
    ...
    [HBNetRequest Get:GETALLGOODS  para:nil complete:^(id data) {
       _titleArray =  data[@"list"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"namechage" object:self userInfo:@{@"title":cell.textLabel.text}];
}
