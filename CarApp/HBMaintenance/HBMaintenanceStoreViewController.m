...
-(void)pushToPayWithIndex:(NSIndexPath *)indexPath cellAtTable:(UITableView * )tableView{
//    if (tableView==_tableViewClean)  {
//        HBCleanCellModel *model = _cleanArr[indexPath.row];
//        HBMainPayViewController *vc = [[HBMainPayViewController alloc] initWithModel:model maintanaceInfo:_miantenanceModel storeInfo:_mbnamelab.text project:@"清洗"];
...
//    if (tableView==_tableViewCleanDecoration){
//        HBCleanCellModel *model = _decorationArr[indexPath.row];
//        HBMainPayViewController *vc = [[HBMainPayViewController alloc] initWithModel:model maintanaceInfo:_miantenanceModel storeInfo:_mbnamelab.text project:@"装潢"];
//        
//        [self.navigationController pushViewController:vc animated:YES];
//    }
//    if (tableView==_tableViewMaintenance)  {
//        HBCleanCellModel *model = _maincleanArr[indexPath.row];
//        HBMainPayViewController *vc = [[HBMainPayViewController alloc] initWithModel:model maintanaceInfo:_miantenanceModel storeInfo:_mbnamelab.text project:@"保养"];
//        [self.navigationController pushViewController:vc animated:YES];
//    }
}
